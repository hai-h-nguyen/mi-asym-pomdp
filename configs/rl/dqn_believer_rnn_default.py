...
def get_config():
    ...
    # Believer specifics
    config.config_critic.believer = ConfigDict()
    config.config_critic.believer.x_dim = 16
    config.config_critic.believer.x_size = 16
    config.config_critic.believer.latent_dim = 32
    config.config_critic.believer.lr = 3e-4
