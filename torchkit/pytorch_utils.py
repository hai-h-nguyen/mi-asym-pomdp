...
def pad_zeros_last_dim(tensor, desired_len):
    "pad zeros at the end of the last dimension of tensor to desired_len"
    return F.pad(tensor, (0, desired_len - tensor.shape[-1]))
