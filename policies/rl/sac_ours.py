...
class SAC_OURS(RLAlgorithmBase):
    name = "sac-ours"
    ...
    def critic_loss(
        ...
        with torch.no_grad():
            ...
            if markov_actor:
                ...
                (new_actions, new_log_probs), _ = actor(
            ...
            if markov_critic:  # (B, 1)
                ...
                next_q1, next_q2, _ = critic_target(
                    prev_actions=actions,
                    rewards=rewards,
                    observs=observs,
                    states=states,
        ...
        if markov_critic:
            ...
            # Q(h(t), a(t)) (T, B, 1)
            q1_pred, q2_pred, aux_info = critic(
                prev_actions=actions,
                rewards=rewards,
                observs=observs,
                states=states,
        ...
        return (q1_pred, q2_pred), q_target, aux_info
    ...
    def actor_loss(
        ...
        if markov_actor:
            ...
            (new_actions, log_probs), aux_info = actor(
        ...
        return policy_loss, log_probs, aux_info
