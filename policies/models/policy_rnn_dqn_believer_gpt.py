...
from policies.models.recurrent_critic_believer_gpt import Critic_RNN

class ModelFreeOffPolicy_DQN_GPT_Believer(nn.Module):
    ARCH = "memory"
    Markov_Actor = False
    Markov_Critic = False
    ...
    def update_believer_encoder(self, batch):
        ...
        outputs = self.critic.update_believer_encoder(
                                           observs,
                                           states,
                                           masks)
