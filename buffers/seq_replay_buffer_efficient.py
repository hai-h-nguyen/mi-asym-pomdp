...
class RAMEfficient_SeqReplayBuffer:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._states = np.zeros(
            (max_replay_buffer_size, state_dim), dtype=observation_type
        )
    ...
    def add_episode(self, observations, actions, rewards, terminals, next_observations, states, next_states):
        """
    ...
    def _sample_data(self, indices, next_indices):
        return dict(
            ...
            state2=self._states[next_indices],
        )
    ...
    def get_state_dict(self):
        ...
        save_dict["_observations"] = self._observations
        save_dict["_states"] = self._states
        save_dict["_actions"] = self._actions
        save_dict["_rewards"] = self._rewards
        save_dict["_terminals"] = self._terminals
        save_dict["_valid_starts"] = self._valid_starts
    ...
    def load_from_state_dict(self, state_dict):
        ...
        self._observations = state_dict["_observations"]
        self._states = state_dict["_states"]
        self._actions = state_dict["_actions"]
        self._rewards = state_dict["_rewards"]
        self._terminals = state_dict["_terminals"]
        self._valid_starts = state_dict["_valid_starts"]
        self._ends = state_dict["_ends"]
